...
```text
.github/workflows/pr-quality.yml   caller workflow, pinned to imrohitagrawal/.github's v5 tag by commit SHA
...
(with a `# v5` comment for readability), not the mutable tag, per
